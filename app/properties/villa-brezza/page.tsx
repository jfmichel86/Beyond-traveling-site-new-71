...
export default function Page() {
  ...
  const property = {
    ...
    `/properties/villa-brezza/villa-brezza-${i + 1}.jpg`
    ),
  };
      ...
      <section className="pt-10 pb-16 md:pt-14 md:pb-24 bg-white">
        <div className="mx-auto max-w-[1100px] px-6 md:px-10">
          ...
          <div className="mt-6 text-[17px] leading-[1.9] text-slate-900/75 space-y-7 text-justify">
            <p>
              Villa Brezza is a refined five-bedroom retreat inside the exclusive Porta Fortuna community
              in Punta Mita. Steps from Sufi Beach Club, this stylish villa blends the comfort of a private
              home with the luxury of resort living — complete with daily cleaning service, private cook,
              golf privileges, and breathtaking golf-course views.
            </p>
            <p>
              Villa Brezza surrounds you with calm sophistication. 
              Natural textures, soft tones, and open design create an effortless flow between indoor and outdoor living. 
              The spacious terrace is the heart of the home — featuring a shimmering private pool, comfortable loungers, 
  ...
  <div className="mx-auto max-w-[1100px] px-6 md:px-10">
    ...
    <div className="mt-10 grid md:grid-cols-4 gap-8">
      ...
      <div className="rounded-2xl border border-slate-200/80 bg-white p-6 md:p-7 transition duration-300 hover:shadow-md">
        ...
        <p className="mt-2 text-slate-600">One Single Bed</p>
         <p className="mt-2 text-slate-600">Ensuite bathroom </p>
      </div>
