        ...
        <section className="pt-10 pb-16 md:pt-14 md:pb-24 bg-white">
          <div className="mx-auto max-w-[1100px] px-6 md:px-10">
            <div className="mt-6 text-[17px] leading-[1.9] text-slate-900/75 space-y-7 text-justify">
              ...
              <p>
                Las Palmas 28 offers a serene and effortless stay, where natural textures, soft neutral tones, and open 
                spaces create an atmosphere of calm from the moment you arrive. The home flows seamlessly between indoor 
                and outdoor living, with comfortable seating areas, shaded terraces, and views of lush tropical surroundings
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="mt-10 grid md:grid-cols-4 gap-8">
              ...
              <div className="rounded-2xl border border-slate-200/80 bg-white p-6 md:p-7 transition duration-300 hover:shadow-md">
                <h3 className="font-medium text-slate-900">Bedroom 3</h3>
                   <p className="mt-2 text-slate-600">2 Full size Beds plus 2 Twin Beds </p>
                   <p className="mt-2 text-slate-600">Ensuite bathroom </p>
              </div>
            </div>
          </div>
  ...
  <div className="mx-auto max-w-[1100px] px-6 md:px-10">
    ...
    <div className="mt-6 divide-y divide-slate-200 text-[15px]">
      ...
      <div className="flex justify-between py-4">
        ...
        <span>$2,700 USD per night</span>
      </div>

      <div className="flex justify-between py-4">
        <span>Christmas </span>
        <span>$3,000 USD per night</span>
      </div>
      
      <div className="flex justify-between py-4">
        <span>New Year</span>
        <span>$4,000 USD per night</span>
      </div>
    </div>

          {/* IMPORTANT: ul NOT inside p */}
       <ul className="mt-6 space-y-3 text-[12px] text-slate-600 list-disc pl-5">
  <li>There is an extra fee of $80 USD per night for any additional person after 8 guests (Except on peak weeks)</li>
  <li>The rental of the property requires a refundable Security Deposit equivalent to one night.</li>
