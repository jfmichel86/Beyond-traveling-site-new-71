...
export default function Page() {
  ...
  const property = {
    name: "Villa Llamas",
    startingPrice: "$1,600 USD per night",
    images: Array.from({ length: 37 }, (_, i) =>
    `/properties/villa-llamas/villa-llamas-${i + 1}.jpg`
    ),
  };
      ...
      <section className="pt-10 pb-16 md:pt-14 md:pb-24 bg-white">
        <div className="mx-auto max-w-[1100px] px-6 md:px-10">
          ...
          <div className="mt-6 text-[17px] leading-[1.9] text-slate-900/75 space-y-7 text-justify">
            <p>
              Villa Llamas is a warm and elegant five-bedroom retreat nestled inside Punta Mita’s exclusive Porta Fortuna community. 
              Just steps from Sufi Beach Club, this stylish villa offers a perfect balance between relaxed coastal 
              living and modern luxury — with spacious indoor-outdoor areas, daily service, and access to Punta Mita’s 
              premier golf and beach clubs.
            </p>
            <p>
              From the moment you step inside, Villa Llamas welcomes you with an atmosphere of comfort and connection. 
              The open design fills the home with natural light and gentle breezes, blending soft tones, natural wood, 
              and elegant furnishings. The expansive terrace overlooks the lush golf course, featuring a serene private pool, 
              comfortable loungers, and a shaded outdoor dining area — the perfect setting for lazy mornings and sunset gatherings.
            </p>
          </div>
        </div>
      </section>
  ...
  <div className="mx-auto max-w-[1100px] px-6 md:px-10">
    ...
    <div className="mt-10 grid md:grid-cols-4 gap-8">
      ...
      <div className="rounded-2xl border border-slate-200/80 bg-white p-6 md:p-7 transition duration-300 hover:shadow-md">
       ...
       <div className="rounded-2xl border border-slate-200/80 bg-white p-6 md:p-7 transition duration-300 hover:shadow-md">
        <h3 className="font-medium text-slate-900">Extra Bedroom </h3>
        <p className="mt-2 text-slate-600">1 Twin Bunk Beds</p>
         <p className="mt-2 text-slate-600">Ensuite bathroom </p>
      </div>
  ...
  <div className="mx-auto max-w-[1100px] px-6 md:px-10">
    ...
    <div className="mt-6 divide-y divide-slate-200 text-[15px]">
      <div className="flex justify-between py-4">
        ...
        <span>$1,600 USD per night</span>
      </div>

      <div className="flex justify-between py-4">
        <span>High Season (Nov 1st to April 30th)</span>
        <span>$2,100 USD per night</span>
      </div>
      
      <div className="flex justify-between py-4">
        <span>Easter / Thanksgiving</span>
        <span>$3,500 USD per night</span>
      </div>

      <div className="flex justify-between py-4">
        <span>Christmas </span>
        <span>$4,500 USD per night</span>
      </div>
