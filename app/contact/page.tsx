...
export const metadata = {
  title: "Contact Property Management Punta Mita | Beyond Traveling",
  description:
    "Contact Beyond Traveling for luxury property management in Punta Mita. Speak directly with our local team.",
};
